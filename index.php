...
<body>
    ...
    <p><a href="insert.php">Insert New Chef</a></p>
        ...
        <?php if (!isset($_GET['searchBtn'])) { ?>
            ...
            <?php foreach ($getAllChefs as $row) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit.php?id=<?php echo $row['chef_id']; ?>">Edit</a>
                        <a href="delete.php?id=<?php echo $row['chef_id']; ?>">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        <?php } else { ?>
            <?php $searchForAChef = searchForChef($pdo, $_GET['searchInput']); ?>
            <?php foreach ($searchForAChef as $row) { ?>
                <tr>
                    <td><?php echo $row['chef_id']; ?></td>
                    <td><?php echo $row['first_name']; ?></td>
                    <td><?php echo $row['last_name']; ?></td>
